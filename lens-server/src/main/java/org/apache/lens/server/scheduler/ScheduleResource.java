...
public class ScheduleResource {
  public static final Logger LOG = LogManager.getLogger(ScheduleResource.class);
  ...
  public ScheduleResource() throws LensException {
    schedulerService = (SchedulerService) LensServices.get().getService("scheduler");
  }
  ...
  public List<String> getAllSchedule(@QueryParam("sessionid") LensSessionHandle sessionid,
      @DefaultValue("") @QueryParam("status") String status, @DefaultValue("") @QueryParam("user") String user) {
    checkSessionId(sessionid);
    try {
      return schedulerService.getAllSchedules(sessionid, status, user);
  ...
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public JAXBElement<XSchedule> getScheduleDefn(@QueryParam("sessionid") LensSessionHandle sessionHandle,
  ...
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public ScheduleInfo getScheduleInfo(@QueryParam("sessionid") LensSessionHandle sessionHandle,
      @PathParam("scheduleid") String scheduleid) {
    checkSessionId(sessionHandle);
    try {
      return schedulerService.getLensSchedule(sessionHandle, scheduleid);
    } catch (LensException e) {
      throw new WebApplicationException(e);
    }
  }
  ...
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public List<String> getScheduleRuns(@QueryParam("sessionid") LensSessionHandle sessionHandle,
      @PathParam("scheduleid") String scheduleid) {
    checkSessionId(sessionHandle);
    try {
  ...
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public ScheduleRunInfo getScheduleRunDetail(@QueryParam("sessionid") LensSessionHandle sessionHandle,
      @PathParam("scheduleid") String scheduleid, @PathParam("runid") String runHandle) {
    checkSessionId(sessionHandle);
    try {
      return schedulerService.getScheduleRunDetail(sessionHandle, scheduleid, runHandle);
    } catch (LensException e) {
      throw new WebApplicationException(e);
    }
  }
  ...
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public String schedule(@QueryParam("sessionid") LensSessionHandle sessionHandle,
      @FormDataParam("lensschedule") XSchedule schedule) {
    checkSessionId(sessionHandle);
    try {
  ...
  @Consumes({ MediaType.MULTIPART_FORM_DATA })
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public boolean updateTask(@QueryParam("sessionid") LensSessionHandle sessionHandle,
      @PathParam("scheduleid") String scheduleid, @QueryParam("newlensschedule") XSchedule newSchedule) {
    checkSessionId(sessionHandle);
    try {
      return schedulerService.updateSchedule(sessionHandle, scheduleid, newSchedule);
    } catch (LensException e) {
      throw new WebApplicationException(e);
    }
  }
  ...
  public void statusUpdate(@PathParam("scheduleid") String scheduleid,
      @QueryParam("sessionid") LensSessionHandle sessionHandle, @QueryParam("newstatus") String newstatus) {
    checkSessionId(sessionHandle);
    try {
      schedulerService.updateStatus(sessionHandle, scheduleid, newstatus);
    } catch (LensException e) {
      throw new WebApplicationException(e);
    }
  }
  ...
  @Path("/schedules/{scheduleid}/runs/{runid}")
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public boolean rerun(@PathParam("scheduleid") String scheduleid, @PathParam("runid") String runid,
      @QueryParam("sessionid") LensSessionHandle sessionHandle) {
    checkSessionId(sessionHandle);
    try {
  ...
  @Path("/schedules/{scheduleid}")
  @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.TEXT_PLAIN })
  public boolean deleteSchedule(@QueryParam("sessionid") LensSessionHandle sessionHandle,
      @PathParam("scheduleid") String scheduleid) {
    checkSessionId(sessionHandle);
    try {
